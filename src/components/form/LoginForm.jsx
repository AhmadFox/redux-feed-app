...
const LoginForm = ({addStyle}) => {
	...
	<form onSubmit={submitHandler} className={`grid gap-y-6 ${addStyle}`}>
		<div className="">
			...
			<InputBox type={'text'} holder={'Ex: example@domain.com'} addStyle={'bg-purple-50 border border-purple-300 w-full'}/>
		</div>
		<div className="">
			<label className="mb-2 text-purple-700 capitalize block font-medium">Password:</label>
			<InputBox type={'password'} holder={'Ex: xxxxxx'} addStyle={'bg-purple-50 border border-purple-300 w-full'}/>
		</div>
